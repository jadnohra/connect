...
def print_tuple_tree(root_tuple: tuple, namer_func: Callable = (lambda x: str(x))):
    """Print a tuple tree (node, [children])"""
    print_tree(root_tuple,
               lambda tuple: tuple[1],
               lambda tuple: namer_func(tuple[0]))
